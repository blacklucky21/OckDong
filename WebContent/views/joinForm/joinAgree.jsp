...
<span class="mname">회원가입</span>
    ...
    <div class="terms">
        <form id="formTerms" name="formTerms" method="post" action="<%= request.getContextPath() %>/views/joinForm/memberJoin.jsp">
            <input type="hidden" name="token" value="MTU2NTcxMjUxODM3NDA5ODY4ODQwNDk0NDkyMzc3NTYyMzkwNjQzNzEx">
            ...
            <p class="all-agree">
                ...
                <label for="allAgree">
                    <span><strong>WIZDESIGN의 모든 약관을 확인하고 전체 동의합니다.</strong></span>
                    (전체동의, 선택항목도 포함됩니다.)
                </label>
            </p>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#btnNextStep').click(function () {
        	window.location.href = '<%= request.getContextPath() %>/views/joinForm/memberJoin.jsp';
        });
